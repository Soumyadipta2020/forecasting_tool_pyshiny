        ...
        ui.div(
            ui.layout_columns(
                ui.card(
                    ...
                    ui.tags.details(
                        ...
                        ui.div(
                            ...
                            ui.input_select(
                                "best_model_metric",
                                "Best Model Metric",
                                choices=["MAPE", "sMAPE", "MASE", "WAPE", "MdAPE", "RMSE", "MAE", "R2", "BIC", "Coverage", "Avg Width", "Width/Mean", "Accuracy", "F1"],
                                selected="MASE",
                            ),
                    ...
                    ui.output_ui("model_transparency_note"),
                    ui.tags.details(
                        ui.tags.summary(
                            ui.span("Tuning"),
                            ui.tags.i(class_="fa-solid fa-chevron-down"),
                        ...
                        ui.div(
                            ui.input_checkbox("tune_hyperparameters", "Tune Hyperparameters", value=False),
                            ui.input_numeric("tuning_cv_folds", "CV Folds", value=3, min=2),
                            ui.div(
                                "Uses compact grids so interactive runs stay responsive.",
                ...
                ui.div(
                    ...
                    ui.navset_card_tab(
                        ...
                        ui.nav_panel(
                            ...
                            ui.panel_conditional(
                                "input.data_type === 'Time Series'",
                                ui.output_ui("interval_quality_report"),
